    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-10 py-20">
        <div className="lg:flex-1 max-w-lg mb-10 lg:mb-0">
          ...
          Hi, I'm Oca, a passionate Informatics Engineering student focusing on Frontend Development. I enjoy transforming creative ideas into interactive and user-friendly websites. With a strong foundation in HTML, CSS, and JavaScript, I'm constantly learning modern frameworks like React to improve my skills.
